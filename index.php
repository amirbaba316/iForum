    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1200x400/?coding,javascript" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1200x400/?programing,microsoft" class="d-block w-100" alt="...">
            </div>
        </div>
           ...
           while($row=mysqli_fetch_assoc($result)){
            ...
            <img src="https://source.unsplash.com/500x400/?coding,' . $cat . '" class="card-img-top" alt="...">
              <div class="card-body">
                ...
                <a href="threadslist.php?catid='. $cat_id .'" class="btn btn-danger">Explore</a>
              </div>
              </div>
            </div>';
           }
